...
const Onboarding = () => {
  ...
  return (
    <div className='container d-flex flex-column justify-content-center'>
      ...
      <div className='row d-flex flex-column jsutify-content-center' style={{ width: "60rem" }}>
        <div className="container-fluid card d-flex flex-row border-0" >
          <img src="https://cdn.dribbble.com/users/5536359/avatars/small/96d1605009298139df101ca7391c7d87.jpeg?1660014113" className="card-img-top rounded-circle" style={{ width: "3rem", height: "3rem" }} alt="..." />
          <div className="card-body">
            <h5 className="card-title">Onboarding #Exploration</h5>
            <p className="card-text">Eren Türkmen • Follow•<span style={{ color: "#ea4c89" }}>Hire Me</span></p>
          </div>
          <div className="card-body">
        ...
        <div id="demo" className="carousel slide align-self-center" data-bs-ride="carousel">
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              <img src="https://cdn.dribbble.com/users/5536359/screenshots/15669113/media/67e48efc54b41af96fdceb1eb2f1e8fa.png?compress=1&resize=1000x750&vertical=top" alt="Los Angeles" className="d-block" style={{ width: "100%" }} />
            </div>
